...
title('Direct boundary integral solution to Laplace Equation: $$\Delta u = 0$$ along $$\theta = \frac{\pi}{16}$$','interpreter','latex')
figure(2);
...
title('Error in direct boundary integral solution to Laplace Equation: $$\Delta u = 0$$ along $$\theta = \frac{\pi}{16}$$','interpreter','latex')
